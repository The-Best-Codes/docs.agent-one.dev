...
<Step>
    ...
    If macOS blocks the app from opening, see the [Troubleshooting](#troubleshooting) section below.
...
This warning can appear even when the app itself is fine. If you downloaded AgentOne from `agent-one.dev` or the official GitHub releases page, try these steps.
