...
When a [text-to-speech provider](/docs/desktop-app/chats/reading-aloud) is set up, a speaker icon also appears on assistant messages for reading them out loud.
...
- [Reading Aloud](/docs/desktop-app/chats/reading-aloud) - listen to messages with text-to-speech.
