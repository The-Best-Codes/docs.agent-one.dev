...
These settings apply only to the current chat and do not affect other conversations.
...
- **Edit message** - edit any user message and optionally regenerate from that point.
