...
{/* Screenshot placeholder: main chat window with the empty-state greeting visible, the model selector at the bottom showing a selected model, and the composer input focused. */}
