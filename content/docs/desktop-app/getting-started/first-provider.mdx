...
AgentOne needs at least one enabled model provider before it can answer messages. If you already [signed in with your AgentOne account](/docs/desktop-app/account-and-sync/sign-in-and-plan), you can skip this tutorial entirely and use AgentOne right away.
...
For full provider setup details, continue to [Providers and Models troubleshooting](/docs/desktop-app/troubleshooting/providers-and-models).
