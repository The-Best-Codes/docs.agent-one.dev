...
![Sidebar showing an original chat and a branched chat below it with a branch icon, both visible in the recent chats list.](/images/docs/desktop-app/chats/branching-overview.png)
