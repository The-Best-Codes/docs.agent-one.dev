...
It's important to know these in case [detecting models automatically](/docs/providers/automatic-model-detection) fails so that you can enter them manually.
