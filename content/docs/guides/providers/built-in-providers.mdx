...
{/* Screenshot placeholder: Settings -> Providers page with a built-in provider expanded, the enable toggle on, the API key field masked, and the Add Model Override button visible. */}
