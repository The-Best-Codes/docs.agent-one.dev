...
AgentOne ships with over 20 cloud providers already configured. You only need to enable the ones you want and supply your API keys - there is no URL to configure or custom JSON to write.
