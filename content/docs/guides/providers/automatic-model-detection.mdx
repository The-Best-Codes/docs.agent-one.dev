...
<Callout>
  ...
  In a future update, this feature will be expanded to built-in providers with
  additional options like auto-updating on app startup and periodically in the
  background.
</Callout>
