...
- **Base URL**: `http://127.0.0.1:11434/v1`
  ...
  ![Providers settings page with Local Providers expanded and Ollama visible, showing the built-in Ollama entry and its base URL.](/images/docs/guides/providers/ollama-local-llms.png)
