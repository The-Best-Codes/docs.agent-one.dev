...
- [Per-tool approval overrides](/docs/guides/extensions/approval-and-auth#per-tool-approvals).
- [Auth connection controls](/docs/guides/extensions/approval-and-auth#connect-and-disconnect) for HTTP extensions that require sign-in.
